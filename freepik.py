...
payload = {
    ...
    "styling": {
        ...
        "effects": {
            ...
            "lightning": "studio", # Possible values: tudio, warm, cinematic, volumetric, golden-hour, long-exposure, cold, iridescent, dramatic, hardlight, redscale, indoor-light
            "framing": "portrait" # Possible values: portrait, macro, panoramic, aerial-view, close-up, cinematic, high-angle, low-angle, symmetry, fish-eye, first-person
        }
    },
    "person_generation": "dont_allow", # Possible values: dont_allow, allow_adult, allow_all
    "safety_settings": "block_medium_and_above" # Possible values: block_low_and_above, block_medium_and_above, block_only_high, block_none
}
